@extends('header.apps',['title'=>'Tambah Data Mutasi Logistik'])
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                   ...
                   <table class="table table-responsive" align="center">
                    ...
                    <tr>
                        <td>Tanggal Mutasi<span class="text-danger" title="This field is required">*</span></td><td>:</td><td><input type="date" name="Tanggal_Mutasi" autocomplete="off" placeholder="Masukan Tanggal Mutasi..." class="form-control form-control-user @error('Tanggal_Mutasi') is-invalid @enderror" autofocus>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Save Data Mutasi Logistik</button>
