@extends('header.apps',['title' => 'Detail User'])
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
            <div class="my-2"></div>
            <a href="registerUser" id="btn_add_new_data" class="btn btn-success btn-social" title="Tambah Data">
            ...
            <div class="card-body">
                <p>Form Untuk Menambahkan Data <code>Users</code></p>
            </div>
        </div>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
