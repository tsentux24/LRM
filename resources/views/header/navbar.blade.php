...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
            ...
            <div class="sidebar-brand-text"><font size="2">Logistic Report System <sup>LRM</sup></font></div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/DetailUser">Register</a>
        ...
        <!-- Nav Item - Charts -->
        <li class="nav-item">
            <a class="nav-link" href="/vendor_detail">
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link" href="/wilayah_detail">
                <i class="fas fa-fw fa-table"></i>
                <span>Wilayah</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/wp_detail">
                <i class="fas fa-fw fa-house-user"></i>
                <span>Wajib Pajak</span></a>
        </li>
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="https://eu.ui-avatars.com/api/?name={{ Auth::user()->name }}&bold=true&background=1B699A&color=FFFFFF" alt="Profile" class="rounded-circle"">
                        </a>
